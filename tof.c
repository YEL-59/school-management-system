...
int main()
{
    ...
    printf("\n\n\t\t\t\tThe pyscripters Team");
    printf("\n\n\t\t\t Daffodil International University\n\t\t\t");
    printf("\n\n\tProject  Name: School Management System\n");
    printf("\tProject Team Name: Pyscripters\n");
    printf("\tProject Team Member: \n");
    printf("\n\t\tMiskat-ul-showmik(181-15-10737)\n");
    printf("\n\t\tMd.Tofayel Islam(181-15-10659)\n");
    printf("\n\t\tMd.Sakil Ahmed(181-15-10539)\n");
